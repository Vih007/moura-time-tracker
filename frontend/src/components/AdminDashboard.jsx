...
import {
    ...
    ListOrdered, Timer, Menu // Imports combinados
} from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // Novo Estado Mobile
    ...
    // Função auxiliar para navegação mobile
                            ...
                            <div key={r.id} className="history-item">
                                <div style={{display:'flex', gap:'10px', alignItems:'center'}}>
                                    ...
                                    <div>
                                        ...
                                        <span style={{fontSize:'0.75rem', color:'#666'}}>{r.action} • {r.checkin_time}</span>
                                    </div>
                                </div>
                            </div>
                        ))}
        ...
        <div className="dashboard-container">
            ...
            <aside className={`sidebar ${isMobileMenuOpen ? 'mobile-open' : ''}`}>
                ...
                <nav>
                    ...
                    >
                        <ListOrdered size={20} /> <span>Registros</span>
                    </div>
                    <div
